...
This is a list of some personal projects I've worked on over the years.  Before Github, I never kept a comprehensive project log so a lot of this was written retrospectively.
...
<strong>Link:</strong> <a href="http://davidpetrie.com/?p=303">Blog post</a>
A WYSIWIG interface builder for OpenGL and OpenGLES games.
* [Blog Post]()
* [Github repository](https://github.com/cdave1/hdk-tango-v1)

## FTGLES

<strong>Link:</strong> <a href="http://github.com/cdave1/ftgles">http://github.com/cdave1/ftgles</a>
...
[Multitouchscreen on github](http://github.com/cdave1/multitouchscreen)

## Coin Toy

<strong>Link:</strong> <a href="http://www.cointoy.com/">www.cointoy.com</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/DistGameOfLife.tar.gz">DistGameOfLife.tar.gz</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/algorithms.py">algorithms.py</a>
...
<a href="http://www.davidpetrie.com/files/sb_Screenshot1.gif"><img src="http://www.davidpetrie.com/files/sb_Screenshot1.gif" width="500px" /></a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/qs.prolog">qs.prolog</a>
Just a really compact quicksort function written in Prolog.

## www.bandyboo.com

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/bandyboo.tar.gz">Source code</a>
...
Screenshot:
<a href="http://www.davidpetrie.com/files/bb.JPG"><img src="http://www.davidpetrie.com/files/bb.JPG" width="500px" /></a>

## Peachy &#8211; a web based command line tool

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/peachy.ws.tar.gz">Source code</a>
...
<strong>Link:</strong> <a href="http://www.newstoday.co.nz/">www.newstoday.co.nz</a>, <a href="http://www.sportnow.co.nz/">www.sportnow.co.nz</a>
...
<strong>Link:</strong> <a href="http://www.moviehouse.co.nz/">www.moviehouse.co.nz</a>
Moviehouse was a DVD retail business I started in 2003 and ran on the side for a few years. Allowed me to amass a nice DVD collection and a car. Sold 2005.
<a href="http://www.davidpetrie.com/files/mhNewScreen.png"><img width="500px" src="http://www.davidpetrie.com/files/mhNewScreen.png" /></a>


## Disk Simulator

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/DiskSim.tar.gz">DiskSim.tar.gz</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/Tetris.src.zip">Source code</a>
A tetris clone written in C++ using directx.

## 3D Tetris

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/3DTetris.src.zip">Source code</a>, <a href="http://www.davidpetrie.com/files/Tetris.zip">Executable</a>
Modified the tetris above to use 3D blocks. Though the code is obviously quite a lot different.

## Totara

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/totara.tar.gz">Source</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/SokobanSolver.tar.gz">Source code</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/BayesClassifier/">Source code listing</a>
A compact <a href="http://en.wikipedia.org/wiki/Bayes_filter">naive Bayes classifier</a> written in python with some training and testing files.

## Dynamic Decision Tree

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/DynamicDecisionTree.tar.gz">Source code listing</a>
A python program that can take classification information (in the source code, hepatitis symptoms) and then create a <a href="http://en.wikipedia.org/wiki/Decision_tree">decision tree</a> to predict the outcome of future scenarios.

## nachos &#8211; Operating System

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/nachos.tar.gz">Source code listing</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/HaskellDataStructures/">Source code listing</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/GeneticProgramming.tar.gz">Source code listing</a>. Requires <a href="http://jgap.sourceforge.net/">jgap</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/RegexSim.tar.gz">Source code listing</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/vendory.com.tar.gz">Source code </a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/tagworldcup.com.tar.gz">Source code</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/RegisterMachine">Source code listing</a>
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/NearestNeighbour/">Source code listing</a>
A very short python program implementing the <a href="http://en.wikipedia.org/wiki/K-nearest_neighbor_algorithm">k-nearest-neighbour</a> classification algorithm.
...
<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/comet_old.tar.gz">Source code</a>
Online DVD Rental concept along the lines of Netflix. I couldn't get the financials to work, so I shut it down after a successful but unprofitable beta.
<img src="http://www.davidpetrie.com/files/comet_ss.JPG" width="300px" />

## UniTutor

<strong>Link:</strong> <a href="http://www.davidpetrie.com/files/main30.gif">Image</a>
Unitutor was a tutor-student matching business a friend and I ran for two years while at university.
